...
- `dotnet test FamilyChat.sln --no-build --no-restore`: PASS locally, 92 contract/authorization/security/input/retry/retention/notification tests; Docker-backed migration test skipped locally by design
